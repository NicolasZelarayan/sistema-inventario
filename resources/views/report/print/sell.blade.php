   ...
   <div class="container">
   	 <div class="row">
						...
						<thead>
							...
							<tr style="border: none !important;">
								<td colspan="11" style="border: none !important;"><p style="text-align: center;font-weight: bold;">Reporte de Ventas del {{ date('j M Y',strtotime($start_date)) }} Al {{ date('j M Y',strtotime($end_date)) }}</p></td>
							...
							<tr>
								...
								<th>Vendedor</th>
								<th>Cantidad</th>
								<th>Precio costo por unidad</th>
								<th>Precio Venta</th>
								<th>Descuento</th>
								<th>Total Costoa</th>
								<th>Total importe venta</th>
